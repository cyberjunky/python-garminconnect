...
menu_categories = {
    ...
    "3": {
        ...
        "options": {
            ...
            "7": {"desc": f"Get Fitness Age data for '{config.today.isoformat()}'", "key": "get_fitnessage"},
...
def execute_api_call(api: Garmin, key: str) -> None:
    ...
    try:
        ...
        api_methods = {
            ...
            "get_fitnessage": lambda: display_json(f"api.get_fitnessage('{config.today.isoformat()}')", api.get_fitnessage(config.today.isoformat())),
